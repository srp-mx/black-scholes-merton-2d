...
indica que mientras más fina sea la malla, mas rígido es el sistema. Como la
estabilidad requiere $\Delta t \leq \frac{2}{|\lambda_{\max{}}|}$, entonces
\begin{equation}
    \Delta t \leq \frac{1}{2\alpha\pp{\Delta x^{-2} + \Delta y^{-2}}}
\label{eq:stiff-lin}
\end{equation}
